...
import { NavigationServiceName, NavigationService, NavigationEntry } from './navigation.service';
import { NavigationModule } from './navigation.module';

describe(`${NavigationModule}.${NavigationServiceName}`, () => {

    let testUnit: NavigationService;
    ...
    describe('.forState()', () => {
        ...
        it('should add an object with the "text" and "state" to .entries', () => {
            ...
            expect(testUnit.entries)
                .toContain(jasmine.objectContaining(data));
        });
